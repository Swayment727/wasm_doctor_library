...
$(BUILD_DIR)/$(TARGET).a: $(BUILD_DIR)/wasm_doctor.o $(BUILD_DIR)/mem_addr_validator.o $(BUILD_DIR)/heap_use_validator.o $(BUILD_DIR)/local_validator.o $(BUILD_DIR)/error_reporter.o $(BUILD_DIR)/wasm_state.o
	ar rcs $@ $^
