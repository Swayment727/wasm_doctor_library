...
void validate_region(struct mem_addr_validator *validator, doctorptr_t bit_idx_start, doctorptr_t bit_idx_end);
void invalidate_region(struct mem_addr_validator *validator, doctorptr_t bit_idx_start, doctorptr_t bit_idx_end);
void check_region_access(struct mem_addr_validator *validator, doctorptr_t bit_idx_start, doctorptr_t bit_idx_end);
